"""
presale_seed.py — Populate a personal demo/sandbox tenant for the presale
engineer (d.ogbudu@profitbuyz.com), used for customer demos and bug-hunting.

Copied from demo_seed.py — same realistic dataset, different account, kept
completely separate from the canonical demo@phixtra.com account (used for
recordings/tours) so his testing never collides with anyone else's demo.

Usage:
    cd /root/phixtra-app/api-key-manager
    python presale_seed.py

Run it again any time to reset his sandbox back to a clean state — it
deletes the tenant first, then re-creates everything.
"""
...
DEMO_EMAIL    = "d.ogbudu@profitbuyz.com"
DEMO_PASSWORD = "@AdG6f72Gbzup8-7"
DEMO_BUSINESS = "Presale Sandbox — D. Ogbudu"
...
# ── 1. Remove any existing sandbox data ────────────────────────────────────────
print("🧹  Cleaning up old sandbox data...")
...
plain_key = "px-presale-" + "".join(secrets.choice(string.ascii_lowercase + string.digits) for _ in range(24))
cur.execute("""
    ...
    VALUES (%s, %s, %s, 'presale-sandbox.ng', 'whatsapp', TRUE,
...
fake_pid = "77299" + "".join(secrets.choice(string.digits) for _ in range(11))
cur.execute("""
    ...
    VALUES (%s, %s, 'DEMO_ACCESS_TOKEN_PLACEHOLDER', '123456789099999',
            %s, 'presale-internal-key',
            '+234 802 345 6789', %s, TRUE,
            'embedded', NOW() - INTERVAL '18 days')
""", (tenant_id, fake_pid, secrets.token_hex(16), DEMO_BUSINESS))
...
conversations = [
    ...
    ("2348031234567", [
        ...
        ("outbound", "Welcome! I'm your AI shopping assistant. May I have your name please?", 72, "ai_reply"),
    ...
    ("2348121234568", [
        ...
        ("outbound", "Welcome! I'm your AI shopping assistant. May I have your name please?", 48, "ai_reply"),
    ...
    ("2348051234569", [
        ...
        ("outbound", "Welcome! I'm your AI shopping assistant. May I have your name please?", 120, "ai_reply"),
        ...
        ("outbound", "Perfect Mr. Babatunde! Your order request has been received. Our team will contact you within 2 hours to confirm delivery details. Thank you!", 116, "ai_reply"),
    ]),
    ("2348091234570", [
        ("inbound",  "Hi, what earbuds do you have?", 168, "text"),
        ("outbound", "Welcome! I'm your AI shopping assistant. May I have your name please?", 168, "ai_reply"),
    ...
    ("2347031234571", [
        ...
        ("outbound", "Wa alaikum salam! Welcome. May I have your name please?", 200, "ai_reply"),
    ...
    ("2348141234572", [
        ...
        ("outbound", "Welcome! I'm your AI shopping assistant. May I have your name please?", 36, "ai_reply"),
    ...
    ("2348061234573", [
        ...
        ("outbound", "Good evening! Welcome. May I have your name please?", 5, "ai_reply"),
        ("inbound",  "Seun", 4, "text"),
    ...
    ("2348171234574", [
        ...
        ("outbound", "Welcome! May I have your name please?", 720, "ai_reply"),
...
for day_offset in range(30):
    ...
    for _ in range(msgs_today):
        ...
        cur.execute("""
            ...
            VALUES (%s, %s, 'presale-sandbox.ng', 'paid', %s, %s, %s)
        """, (tenant_id, api_key_id, f"sess-{phone[-6:]}-{day_offset}-{hour}", tokens, ts))

# ── 12. Invoices ──────────────────────────────────────────────────────────────
print("🧾  Creating invoices...")
invoice_data = [
    ("PHX-PRESALE-0001", 5000,  500_00,  50_00,  "gbp", days_ago(25)),
    ("PHX-PRESALE-0002", 10000, 1000_00, 100_00, "gbp", days_ago(18)),
    ("PHX-PRESALE-0003", 10000, 1000_00, 100_00, "gbp", days_ago(11)),
    ("PHX-PRESALE-0004", 20000, 2000_00, 200_00, "gbp", days_ago(4)),
]
...
orders_data = [
    ("PS-10231", "2347031234571", "Ibrahim Musa", "INTENT_CAPTURED",
     [("Dell Inspiron 15", 1, 349_000)], 5_000, None,
     6, None, None, None, None, None),
    ("PS-10232", "2348141234572", "Chioma Eze", "PAYMENT_PENDING",
     [("Anker PowerCore 20000", 1, 28_000)], 2_500, None,
     5, None, None, None, None, None),
    ("PS-10233", "2348091234570", "Ngozi Okonkwo", "RECEIPT_RECEIVED",
     [("Sony WF-1000XM4", 1, 95_000)], 3_000, None,
     4, None, None, None, None, None),
    ("PS-10234", "2348051234569", "Babatunde Fashola", "PAYMENT_VERIFIED",
     [("Samsung Galaxy S24 Ultra 512GB", 1, 1_149_000)], 5_000, None,
     3, 3, None, None, None, None),
    ("PS-10235", "2348171234574", "Fatima Bello", "DISPATCHED",
     [("iPad Air M1 256GB", 1, 729_000)], 4_000, None,
     6, 5, 2, None, "GIG-2284910", "GIG Logistics"),
    ("PS-10236", "2348061234573", "Seun Adesanya", "DELIVERED",
    ...
    ("PS-10237", "2348121234568", "Adaeze Nwosu", "CANCELLED",
...
print()
print("=" * 60)
print("✅  Presale sandbox seeded successfully!")
print("=" * 60)
